...
```{=html}
    <div class="field-menu-panel">
      ...
      <!-- In-app live camera: one continuous getUserMedia stream for the whole
           4-photo session, with the compass bearing overlaid on the preview so
           it stays visible while aiming. Hidden until the stream is running;
           falls back to the native #concealCamera input below if unavailable. -->
      <div id="concealLive" class="conceal-live" hidden>
        <div class="conceal-live-wrap">
          <video id="concealVideo" class="conceal-video" autoplay muted playsinline></video>
          <div class="conceal-live-overlay">
            <div class="conceal-live-bearing" id="concealLiveBearing">--°</div>
          </div>
        </div>
        <button type="button" id="concealShutterBtn" class="field-button conceal-capture">Capture photo</button>
      </div>

      <!-- Native-camera fallback (also used before the live stream starts). -->
      <button type="button" id="concealCaptureBtn" class="field-button conceal-capture" hidden>Capture photo</button>
      ...
      <div id="ivActiveFields" style="display:none;">
        ...
        <label class="field-field-label">Nest status
          <select id="ivNestStatus" class="field-input">
            <option value="CN">Nest structurally complete</option>
            <option value="IN">Nest materials present, nest incomplete</option>
            <option value="DN">Damaged nest</option>
            <option value="FN">Flattened nest with fecal matter</option>
            <option value="RN">Nest disappeared for unknown reason</option>
          </select>
        </label>
        <label class="field-field-label">Young status
          <select id="ivYoungStatus" class="field-input">
            <option value="NO">No young present at nest</option>
            <option value="HY">At least one hatching or just emerged</option>
            <option value="NY">Nestlings naked and pink, eyes closed</option>
            <option value="PY">Wing feathers emerging, skin visible, eyes open</option>
            <option value="BY">Body feathers cover skin, stubby tail feathers</option>
...
```{=html}
    <div class="field-menu-panel">
      ...
      <div class="field-waypoint-actions nest-info-actions">
        ...
        <button type="button" id="niAddIntervalBtn" class="field-button">Add interval</button>
        <button type="button" id="niAddGpsBtn" class="field-button"
                style="display:none;">Add GPS point</button>
      </div>
