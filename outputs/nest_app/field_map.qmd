...
```{=html}
    <div class="field-menu-panel">
      ...
      <label class="field-field-label">Patch
        <!-- Defaults to the closest patch; override if the auto guess is wrong. -->
        <select id="ndPatchId" class="field-input"></select>
      </label>

      <div class="field-field-label">Species</div>
      <!-- Single-select (one species per nest); radios injected by JS. -->
      <div id="ndSpeciesGrid" class="field-choice-grid"></div>
      <label class="field-field-label field-other-label">Other species
        <input type="text" id="ndSpeciesOther" class="field-input"
               placeholder="If not listed above" autocomplete="off">
      </label>

      <label class="field-field-label">Discovery stage
        <select id="ndDiscoveryStage" class="field-input">
      ...
      <label class="field-field-label">Camera or control
        <select id="ndCameraOrControl" class="field-input">
      ...
      <!-- Multi-select (a nest can sit in several plants); checkboxes injected by JS. -->
      <div id="ndSubstrateGrid" class="field-choice-grid"></div>
      <label class="field-field-label field-other-label">Other substrate
      ...
      <label class="field-field-label">Location description
        <textarea id="ndLocationDescription" class="field-input" rows="3"
                  placeholder="Where is the nest relative to landmarks?"></textarea>
      </label>
