...
source(
  here("brian_sandbox/nest_app/app_functions.R")
)
...
icons <-
  list.files(
    here("brian_sandbox/nest_app/icons"),
    pattern = "png$",
    full.names = TRUE
  ) %>% 
...
map_mobile_friendly <-
  ...
  appendContent(
    tags$style(
      HTML(
        read_file(
          here("brian_sandbox/nest_app/map_styles.css")
        )
      )
    )
  )
...
map_tracking <-
  ...
  onRender(
    read_file(
      here("brian_sandbox/nest_app/map_tracking.js")
    )
  )
...
map_tracking <-
  map_tracking %>%
  onRender(
    read_file(here("brian_sandbox/nest_app/map_weather.js"))
  )
  ...
  tryCatch(
    {
      ...
      source(
        here("brian_sandbox/nest_app/schedule_for_map.R"),
        local = sched_env
      )
...
tile_cache_dir <- here("brian_sandbox/nest_app/offline_tiles")
...
writeLines(
  ...
  here("brian_sandbox/nest_app/field_patches.js")
)

writeLines(
  c("/* field_icons.js */", field_icons_js),
  here("brian_sandbox/nest_app/field_icons.js")
)

writeLines(
  c("/* field_offline_tiles.js */", field_offline_tiles_js),
  here("brian_sandbox/nest_app/field_offline_tiles.js")
)
...
writeLines(
  ...
  here("brian_sandbox/nest_app/field_data.js")
)
