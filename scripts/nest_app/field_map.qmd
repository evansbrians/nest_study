    ...
    <div class="field-menu-panel">
      ...
      <div class="field-tilegrid">
        ...
        <button type="button" class="field-tile" data-screen="speciesinfo">
          <img class="field-tile-icon" src="icons/dove-solid-full.svg" alt="">
...
source(here::here("scripts/nest_app/species_info.R"))
...
source(here::here("scripts/nest_app/nests.R"))
...
```{=html}
    <div class="field-menu-panel">
      ...
      <div class="field-doc-content" id="scheduleDoc">
        The schedule will appear here soon!
      </div>
    </div>
```
:::
...
htmltools::tags$script(
  htmltools::HTML(
    paste(
      readLines(here::here("outputs/test_pages/scripts/accordion.js")),
      collapse = "\n"
    )
  )
)
